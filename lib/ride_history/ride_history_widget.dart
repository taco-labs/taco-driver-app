              ...
              Expanded(
                child: FutureBuilder<ApiCallResponse>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final listViewListTaxiCallResponse = snapshot.data!;
                    return Builder(
                      builder: (context) {
                        final rideHistories = TaxiCallGroup.listTaxiCallCall
                            .callList(
                        ...
                        return RefreshIndicator(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, rideHistoriesIndex) {
                              final rideHistoriesItem =
                                  rideHistories[rideHistoriesIndex];
                              return Visibility(
                                visible: functions
                                    .isCompletedCallRequest(getJsonField(
                                  rideHistoriesItem,
                                  r'''$.currentState''',
                                ).toString()),
                                child: Padding(
