...
class AppStateNotifier extends ChangeNotifier {
  TacoDriverFirebaseUser? initialUser;
  TacoDriverFirebaseUser? user;
  ...
  void update(TacoDriverFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? HomeWidget() : VerifyCodeWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
